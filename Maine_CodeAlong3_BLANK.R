# ---- Description ----
# This is part III of the code along
...
# ---- Visualizations {base} ----
# Use {base} to quickly generate
# diagnostic plots or to 'check' data

# plot(): scatterplot, two numeric vectors

# plot(): boxplot, one numeric vector, one factor vector
